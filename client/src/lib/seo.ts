...
export const siteConfig = {
  ...
  keywords: [
    ...
    'Huayue Plastic Factory',
    'Eider & Huayue PPR Piping System',
    'Hongyue Plastic Group',
    'Huayue Manufacturing Ethiopia',
    'Huayue PPR Solutions',
    'Huayue Pipes and Fittings',
    'Huayue Ethiopia Factory',
    // PPR & Plastic Pipe Products
    'PPR Piping System',
    'PPR Pipe and Fittings',
    'PPR Pipe Fitting',
    'PPR Pipes Supplier',
    'PPR Pipes Manufacturer Ethiopia',
    'PPR Water Supply System',
    'PPR Plumbing System',
    ...
    'PPR Valve',
    'PPR Socket',
    // Other Plastic Piping Categories
    'PVC Pipe',
    'PVC Pipe for Drainage',
    'PVC Pipe Manufacturer in Ethiopia',
    'PE Pipe',
    'HDPE Pipe',
    'PEXA Pipe',
    'PERT Pipe',
    ...
    'Plumbing Pipes for Buildings',
    'Industrial Water Transport Pipes',
    ...
    'Construction Material Factory in Ethiopia',
    'Plumbing Supplies Ethiopia',
    'PPR Pipes in Addis Ababa',
    'PPR Distributor Ethiopia',
    'Ethiopian Plastic Industry',
    // Quality & Standards
    'Durable PPR Pipes',
    'Certified PPR Pipe Manufacturer',
    'ISO Certified Plastic Factory',
    'High Pressure Resistant Pipes',
    'Heat Resistant Plastic Pipes',
    'Environmentally Friendly PPR Pipes',
    'Leak Proof Piping System',
    'Long Lifespan Water Pipes',
    // Partnership & Export
    'PPR Export from Ethiopia',
    'Africa PPR Pipe Supplier',
    'Industrial Partnership with Huayue',
    'Huayue Distribution Network',
    'Construction Material Export Ethiopia',
  ],
};
